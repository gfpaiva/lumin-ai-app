## Purpose
Controlar e exibir animações de carregamento (loading states) e transições visuais (fade-out, fade-in, pulse) na tela de detalhes da aula enquanto uma recalibração de atividade estiver em andamento.
